...
export default function SuitsPage() {
  const products = getProductsByCategory("بدل")
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-12">
        <h2 className="text-4xl font-bold mb-8 text-foreground">بدل</h2>
        <p className="text-lg text-muted-foreground mb-12 leading-relaxed max-w-3xl">
          بدل نسائية راقية بتصاميم عصرية تناسب المناسبات الرسمية والاستخدام اليومي
        </p>
