...
import { saveDesignSettings, getDesignSettings } from "@/lib/supabase/design-settings"
import { useToast } from "@/hooks/use-toast"

export default function AdminDesignPage() {
  const { colors, fonts, layout, setColor, setFont, setLayout, setLogo, reset, logoUrl } = useDesignStore()
  ...
  const handleSaveLayout = () => {
    ...
    toast({
      title: "تم بنجاح!",
      description: "تم تطبيق التخطيط على كل الموقع!"
    })
  }
